...
if %ERRORLEVEL% EQU 0 (
    ...
    echo.
    echo [DEBUG] Checking portable Node.js locations...
    ...
    echo [DEBUG] Checking path 1: %USERPROFILE%\nodejs-portable\npm.cmd
    if exist "%USERPROFILE%\nodejs-portable\npm.cmd" (
        echo [DEBUG] ✓ Path 1 EXISTS!
        ...
        echo [DEBUG] ✗ Path 1 check failed
        ...
        if !NPM_FOUND! EQU 0 (
            ...
            if exist "..\nodejs-portable\npm.cmd" (
                ...
                echo [DEBUG] ✗ Path 2 does not exist
                echo.
                
                echo [DEBUG] Checking path 3: nodejs-portable\npm.cmd
